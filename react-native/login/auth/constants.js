...
export const API_AUTH_USER_REQUEST = 'API_AUTH_USER_REQUEST';
export const API_AUTH_USER_SUCCESS = 'API_AUTH_USER_SUCCESS';
export const API_AUTH_USER_FAILED = 'API_AUTH_USER_FAILED';
