...
| `/modules/calendly/access/token/` `POST`                                       |     body_param `{"grant_type": "authorization_code","code": "your_code","redirect_uri": "you_rediect_uri"}`     | Return a user access token which authenticate all APIS.                                                                                                                                                                                               |
...
| `/modules/calendly/webhook/subscription/` `POST`                               |                    body_params `url, events(array), organization, user, scope, signing_key`                     | The URL where you want to receive POST requests for events you are subscribed to. Creates a Webhook Subscription for an Organization or User. Returns subscribed webhook information.                                                                 |
