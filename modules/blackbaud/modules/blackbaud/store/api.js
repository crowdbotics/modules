...
export const getConstituentCustomFieldListSingleConstituent = (data) => {
  const config = {
    method: "get",
    maxBodyLength: Infinity,
    url: `${globalOptions.url}/modules/blackbaud/constituents/get_constituent_custom_field_list_in_single_constituent/${data.id}/`,
    headers: {
      Authorization: `Bearer ${data.token}`,
      "Content-Type": "application/json"
    }
...
export const getCustomFieldEducationList = (data) => {
  const config = {
    method: "get",
    maxBodyLength: Infinity,
    url: `${globalOptions.url}/modules/blackbaud/constituents/get_custom_field_list_in_education/${data.id}/`,
    headers: {
      Authorization: `Bearer ${data.token}`,
      "Content-Type": "application/json"
    }
...
export const getEducationCustomFieldCategories = (accessToken) => {
  const config = {
    method: "get",
    maxBodyLength: Infinity,
    url: `${globalOptions.url}/modules/blackbaud/constituents/get_education_custom_field_categories/`,
    headers: {
      Authorization: `Bearer ${accessToken}`,
      "Content-Type": "application/json"
    }
...
export const getEducationDegrees = (accessToken) => {
  const config = {
    method: "get",
    maxBodyLength: Infinity,
    url: `${globalOptions.url}/modules/blackbaud/constituents/get_education_degrees/`,
    headers: {
      Authorization: `Bearer ${accessToken}`,
      "Content-Type": "application/json"
    }
