...
const styles = StyleSheet.create({
  ...
  box: { height: 190, width: "100%", backgroundColor: "#fdf1d6", alignItems: "center", justifyContent: "center", paddingBottom: 10 },
  imageBox: { flexDirection: "row", height: 150, alignItems: "center", justifyContent: "center" },
  vector: { height: 20, width: 20, alignSelf: "flex-end", marginRight: 20, marginTop: 15, resizeMode: "contain" },
