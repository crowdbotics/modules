    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_definition_id', models.ForeignKey(db_column='definition_id', on_delete=django.db.models.deletion.CASCADE, to='typeform-webhook.FormDefinition', to_field='definition_id')),
            ],
        ),
    ]
