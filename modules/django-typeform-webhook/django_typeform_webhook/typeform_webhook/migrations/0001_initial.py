# Generated by Django 2.2.28 on 2023-07-26 15:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_definition_id', models.ForeignKey(db_column='definition_id', on_delete=django.db.models.deletion.CASCADE, related_name='form_answers', to='typeform_webhook.FormDefinition', to_field='definition_id')),
            ],
        ),
    ]
