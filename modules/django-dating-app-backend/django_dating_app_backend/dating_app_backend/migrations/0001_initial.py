    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interests', models.ManyToManyField(blank=True, related_name='user_interests', to='dating_app_backend.Interest')),
                ('skills', models.ManyToManyField(blank=True, related_name='user_skills', to='dating_app_backend.Skill')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='upvotepost_post', to='dating_app_backend.Post')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reportpost_post', to='dating_app_backend.Post')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='postmedia_post', to='dating_app_backend.Post')),
            ],
        ),
        migrations.CreateModel(
            name='PostComment',
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='post_media')),
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='postcomment_post', to='dating_app_backend.Post')),
                ('ref_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='postcomment_ref_comment', to='dating_app_backend.PostComment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='likecomment_comment', to='dating_app_backend.PostComment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='downvotepost_post', to='dating_app_backend.Post')),
            ],
        ),
    ]
