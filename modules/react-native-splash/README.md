...
## Usage
Call the `SplashScreen.hide()` in the screen/module that loads as your app starts. Something like this:
...
const HomePage = () => {
    ...
    useEffect(() => {
     //This will hide the splash image once your Home page is completely loaded.
      SplashScreen.hide();  
    }, []);
