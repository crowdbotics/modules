...
class Base(object):
    ...
    def fetch_for_product(self, product, stockrecord=None, options=None):
        """
...
class Structured(Base):
    ...
    def fetch_for_product(self, product, stockrecord=None, options=None):
        ...
        return PurchaseInfo(
            price=self.pricing_policy(product, stockrecord, options),
...
class NoTax(object):
    ...
    def pricing_policy(self, product, stockrecord, options=None):
        ...
        if options and isinstance(options, QuerySet):
            for attribute in options:
                price = attribute.option.option_groups.filter(product_option_group__product=product).first().price
