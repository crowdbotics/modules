            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={appointmentStyles.headingContainer}>
                    ...
                    <Pressable onPress={() => setModalVisible(false)}>
                        <Image source={require(
                          // @ts-ignore
                          "./assets/close.png")} style={appointmentStyles.image} />
                    </Pressable>
                </View>

                <View style={[appointmentStyles.mainContainer]}>
                    <View style={[appointmentStyles.docContainer]}>
                        <Text style={appointmentStyles.descr}>Nuclear cardiac stress test</Text>
                        <Text style={appointmentStyles.titleText}>Tara Tomphson</Text>
                    </View>
                    <View style={appointmentStyles.inner}>
                        <Image source={require("./assets/phone.png")} style={[appointmentStyles.check, { marginRight: 10 }]} />
                        <Image source={require("./assets/message.png")} style={appointmentStyles.check} />
                    </View>
                </View>
                <Text style={[appointmentStyles.title, { marginTop: 15 }]}>Date/time</Text>
                <View style={appointmentStyles.topWrapper}>
                    ...
                    <View style={[appointmentStyles.inner, { marginVertical: 20 }]}>
                        ...
                        <View style={[appointmentStyles.dateContainer, { backgroundColor: "#12D790" }]}>
                            <Text style={[appointmentStyles.month, appointmentStyles.color]}>Mon</Text>
