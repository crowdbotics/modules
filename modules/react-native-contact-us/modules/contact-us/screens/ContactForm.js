			...
			<ScrollView>
				...
				<View style={{ padding: 20 }}>
					...
					<View style={styles.pt14}>
						...
						{emailValidations != '' && <Text >{emailValidations}</Text>}
					...
					<View style={styles.pt14}>
						...
						{messageValidations != '' && <Text >{messageValidations}</Text>}
					</View>
					...
					<TouchableOpacity style={styles.link} onPress={() => Linking.openURL('mailto:cakoso1300@bamibi.com')}>
