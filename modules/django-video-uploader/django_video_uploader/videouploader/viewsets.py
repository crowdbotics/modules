...
from .serializers import (ChannelSerializer, GroupSerializer, ShowcaseSerializer,
                          ...
                          TokenSerializer)
from .services.videouploader import VideoUploaderService
...
class VideoUploaderViewSet(viewsets.GenericViewSet):
    ...
    def create_access_token(self, request):
        ...
        env_vars: "VIDEO_UPLOADER_CLIENT_ID", "VIDEO_UPLOADER_CLIENT_SECRET" (required)
    ...
    def create_showcase(self, request, pk):
        ...
        :body_params str privacy : The privacy level of the showcase. Allowed values are (anybodyobody/team/embed_only/password) 
        :body_params bool review_mode: Whether showcase videos use the review mode URL 
        :body_params str sort: The default sort order of the videos as they appear in the showcase. Allowed values are (added_first/added_last/alphabetical/arranged/likesewest/oldest/plays) 
